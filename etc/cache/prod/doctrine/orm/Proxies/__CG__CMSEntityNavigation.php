 ...
 */
class Navigation extends \CMS\Entity\Navigation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CMS\\Entity\\Navigation' . "\0" . 'id', '' . "\0" . 'CMS\\Entity\\Navigation' . "\0" . 'name', '' . "\0" . 'CMS\\Entity\\Navigation' . "\0" . 'url', 'children', '' . "\0" . 'CMS\\Entity\\Navigation' . "\0" . 'parent', '' . "\0" . 'CMS\\Entity\\Navigation' . "\0" . 'weight'];
        }
