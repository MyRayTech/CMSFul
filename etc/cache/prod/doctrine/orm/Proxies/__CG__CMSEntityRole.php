 ...
 */
class Role extends \CMS\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CMS\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'CMS\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'CMS\\Entity\\Role' . "\0" . 'parent', '' . "\0" . 'CMS\\Entity\\Role' . "\0" . 'permissions'];
        }
    ...
    public function hasPermission($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasPermission', [$name]);
