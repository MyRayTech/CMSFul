 ...
 */
class Config extends \CMS\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CMS\\Entity\\Config' . "\0" . 'id', '' . "\0" . 'CMS\\Entity\\Config' . "\0" . 'key', '' . "\0" . 'CMS\\Entity\\Config' . "\0" . 'value'];
        }
    ...
    public function __set_state($array)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, '__set_state', [$array]);
