 ...
 */
class Permission extends \CMS\Entity\Permission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'CMS\\Entity\\Permission' . "\0" . 'name', '' . "\0" . 'CMS\\Entity\\Permission' . "\0" . 'roles'];
        }
