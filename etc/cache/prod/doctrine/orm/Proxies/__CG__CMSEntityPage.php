...
class Page extends \CMS\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'name', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'slug', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'content', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'lang', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'author', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'created_time', '' . "\0" . 'CMS\\Entity\\Page' . "\0" . 'routes'];
        }
