 ...
 */
class Comment extends \CMS\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CMS\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'CMS\\Entity\\Comment' . "\0" . 'text', '' . "\0" . 'CMS\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'CMS\\Entity\\Comment' . "\0" . 'object_type', '' . "\0" . 'CMS\\Entity\\Comment' . "\0" . 'object_id', '' . "\0" . 'CMS\\Entity\\Comment' . "\0" . 'date'];
        }
