 ...
 */
class Image extends \CMS\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CMS\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'CMS\\Entity\\Image' . "\0" . 'filename', '' . "\0" . 'CMS\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'CMS\\Entity\\Image' . "\0" . 'description', '' . "\0" . 'CMS\\Entity\\Image' . "\0" . 'thumbnail'];
        }
